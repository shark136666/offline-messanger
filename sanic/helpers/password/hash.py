import bcrypt
from helpers.password.exception import GeneratePasswordHashException, ChekPasswordHashException
...
def check_hash(pwd: str, hsh: bytes) ->None:
    try:
        ...
        raise ChekPasswordHashException(str(e))
    if not result:
        raise ChekPasswordHashException
